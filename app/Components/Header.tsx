...
const Header = ({ onMenuClick }: HeaderProps) => {
  ...
  const MY_PROFILE = {
    ...
    avatar: 'https://github.com/abuzar-ali1.png',
      ...
      <div className="flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-gray-800 pl-3 sm:pl-4">
            ...
            {/* PROFILE DROPDOWN */}
            {/* We attach the ref here so we know if clicks are inside this area */}
            <div className="relative ml-1" ref={dropdownRef}>
              ...
              >
                ...
                />
                <ChevronDown 
                  className={`w-3 h-3 text-gray-400 transition-transform duration-200 ${isProfileOpen ? 'rotate-180' : ''} hidden sm:block`} 
                />
              </button>
